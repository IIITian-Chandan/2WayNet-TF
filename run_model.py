...
def build_model(data_set, tensorboard_callback):
    ...
    if data_set.params().L2_LOSS != 0.0 and representation_layer_xy is not None:
        ...
        loss_representation = data_set.params().L2_LOSS * losses.mean_squared_error(representation_layer_xy,
    ...
    def calculate_cca():
        return util.cross_correlation_analysis(representation_layer_xy, representation_layer_yx,
